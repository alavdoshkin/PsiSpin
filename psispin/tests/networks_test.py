...
class NetworksTest(parameterized.TestCase):
  ...
  def test_antisymmetry(self, envelope_label, dtype):
    ...
    feature_layer = networks.make_ferminet_features(nspins, ndim=3)
    ...
    out2 = network.apply(params, pos2, spins2)
    ...
    out3 = network.apply(params, pos3, spins3)
  ...
  def test_create_input_features(self):
    ...
    input_features = networks.construct_input_features(xs)
  ...
  def test_fermi_net(self, vmap, **network_options):
    ...
    if (
      ...
      if vmap:
        ...
        fermi_net = jax.vmap(network.apply, in_axes=(None, 0, 0))
      ...
      params = network.init(subkey)
      sign_psi, log_psi = fermi_net(params, xs, spins)
  ...
  def test_spin_polarised_fermi_net(self, nspins, full_det):
    ...
    sign_out, log_out = network.apply(params, xs, spins)
