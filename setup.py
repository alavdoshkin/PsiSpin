...
def psispin_test_suite():
  test_loader = unittest.TestLoader()
  test_suite = test_loader.discover('psispin/tests', pattern='*_test.py')
  return test_suite
...
setup(
    ...
    url='https://github.com/alavdoshkin/PsiSpin',
    author='Alexander Avdoshkin, Max Geier',
    # Contained modules and scripts.
    entry_points={
        'console_scripts': [
            'psispin = psispin.main:main_wrapper',
        ],
    },
    ...
    platforms=['any'],
    license='Apache 2.0',
    test_suite='setup.psispin_test_suite',
)
